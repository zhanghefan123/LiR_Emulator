...
#include <string>
#define BUILD_PYTHON_36_PATH "../../build-python-image/build_python_36/"
#define BUILD_PYTHON_38_PATH "../../build-python-image/build_python_38/"
#define BUILD_UBUNTU_PATH "../../build-ubuntu-image/"
#define BUILD_SATELLITE_NODE_PATH "../../build-satellite-image"
#define BUILD_GROUND_STATION_PATH "../../build-ground-station-image"

#define UBUNTU_IMAGE_NAME "ubuntu-modified"
#define PYTHON_IMAGE_NAME "ubuntu-python"
#define SATELLITE_NODE_IMAGE_NAME "satellite"
